...
import commerceModules.purchase;
...
public class EndToEndScenario {
	...
	//Registration Process
		...
		//enter emailId
		wd.findElement(By.id("Email")).sendKeys("meenaramu18@gmail.com"+Keys.TAB);
		//enter company
	...
	//Purchase functionality
		...
		org.openqa.selenium.io.FileHandler.copy(img, new File("C:\\Users\\meenakshi.r\\Documents\\selenium screenshots\\order.png"));
